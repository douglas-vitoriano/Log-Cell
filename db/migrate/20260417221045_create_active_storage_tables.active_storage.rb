class CreateActiveStorageTables < ActiveRecord::Migration[8.1]
  def change
    create_table :active_storage_blobs, id: :string, primary_key: :id do |t|
    ...
    create_table :active_storage_attachments, id: :string, primary_key: :id do |t|
    ...
    create_table :active_storage_variant_records, id: :string, primary_key: :id do |t|
